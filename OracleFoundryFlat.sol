...
// OracleBar is the coolest bar in town. You come in with some Oracle, and leave with more! The longer you stay, the more Oracle you get.
//
// This contract handles swapping to and from xORACLE, SushiSwap's staking token.
contract OracleBar is ERC20("OracleFoundry", "xORACLE"){
    using SafeMath for uint256;
    IERC20 public oracle;

    // Define the Oracle token contract
    constructor(IERC20 _oracle) public {
        oracle = _oracle;
    }
    ...
    function enter(uint256 _amount) public {
        ...
        // Calculate and mint the amount of xORACLE the Oracle is worth. The ratio will change overtime, as xORACLE is burned/minted and Oracle deposited + gained from fees / withdrawn.
        else {
    ...
    function leave(uint256 _share) public {
        ...
        uint256 what = _share.mul(oracle.balanceOf(address(this))).div(totalShares);
